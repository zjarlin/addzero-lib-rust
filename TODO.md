...
| [#34](https://github.com/zjarlin/addzero-lib-rust/issues/34) | [Fix] az-browser-automation: Chrome 子进程泄漏 | bug, network |
| [#33](https://github.com/zjarlin/addzero-lib-rust/issues/33) | [Fix] az-curl: CurlExecutor::default() panic if TLS init fails | bug, network |
| [#32](https://github.com/zjarlin/addzero-lib-rust/issues/32) | [Fix] az-curl: Regex 每次调用重编译（性能问题） | bug, priority-high, network |
...
| [#19](https://github.com/zjarlin/addzero-lib-rust/issues/19) | [Impl] az-cte — #1 子任务 | feature, impl |
...
| # | Issue | 标签 |
|---|-------|------|
| [#31](https://github.com/zjarlin/addzero-lib-rust/issues/31) | [Fix] az-reflection::ExpiringCache 构造 panic + expect on Mutex | bug, priority-high, core |
| [#30](https://github.com/zjarlin/addzero-lib-rust/issues/30) | [Fix] az-tree::build_tree 死代码 + 文档误导 | bug, priority-high, core |
| [#22](https://github.com/zjarlin/addzero-lib-rust/issues/22) | [Impl] az-ddl-generator — #1 子任务 | feature, impl |
| [#21](https://github.com/zjarlin/addzero-lib-rust/issues/21) | [Impl] az-sql — #1 子任务 | feature, impl |
| [#20](https://github.com/zjarlin/addzero-lib-rust/issues/20) | [Impl] az-database-model — #1 子任务 | feature, impl |
