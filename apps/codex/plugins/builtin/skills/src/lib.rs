...
use codex_plugin_api::{
    ...
    CatalogTagContribution, CatalogTagGroup, CodexPlugin, ContributionSet, PluginActivation,
    PluginDependency, PluginDescriptor, PluginKind,
};
...
impl CodexPlugin for SkillsPlugin {
