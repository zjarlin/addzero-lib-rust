...
export function createApiClient(baseUrl: string) {
    return {
        ...
        skillStatus: () =>
            request<SyncReportDto>(baseUrl, "/api/skills/status"),
        listNotes: () =>
        ...
        browseFiles: (input: StorageBrowseRequestDto) =>
            request<StorageBrowseResultDto>(
                baseUrl,
                "/api/admin/storage/files/browse",
                {
                    method: "POST",
                    ...jsonBody(input),
                },
        ...
        uploadFiles: (input: StorageUploadRequestDto) =>
            request<StorageUploadResultDto>(
                baseUrl,
        ...
        createFolder: (input: StorageCreateFolderDto) =>
            request<StorageCreateFolderResultDto>(
                baseUrl,
                "/api/admin/storage/files/folders",
                {
                    method: "POST",
                    ...jsonBody(input),
                },
        ...
        shareFile: (input: StorageShareRequestDto) =>
            request<StorageShareResultDto>(
                baseUrl,
                "/api/admin/storage/files/share",
                {
                    method: "POST",
                    ...jsonBody(input),
                },
        ...
        deleteFile: (input: StorageDeleteObjectDto) =>
            request<StorageDeleteResultDto>(
                baseUrl,
                "/api/admin/storage/files/delete",
                {
                    method: "POST",
                    ...jsonBody(input),
                },
        ...
        deleteMenu: (id: number) =>
            request<void>(baseUrl, `/api/admin/system/menus/${id}`, {
                method: "DELETE",
            }),
        ...
        deleteRole: (id: number) =>
            request<void>(baseUrl, `/api/admin/system/roles/${id}`, {
                method: "DELETE",
            }),
        ...
        deleteUser: (id: number) =>
            request<void>(baseUrl, `/api/admin/system/users/${id}`, {
                method: "DELETE",
            }),
        ...
        cliEntry: (id: string) =>
            request<CliMarketEntry | null>(
                baseUrl,
                `/api/cli-market/${encodeURIComponent(id)}`,
            ),
        ...
        cliImport: (input: CliMarketImportRequest) =>
            request<CliMarketImportJobDetail>(
                baseUrl,
                "/api/cli-market/import",
                {
                    method: "POST",
                    ...jsonBody(input),
                },
        ...
        cliJobs: () =>
            request<CliMarketImportJob[]>(
                baseUrl,
                "/api/cli-market/import-jobs",
            ),
        ...
        cliExportJson: (input: CliMarketExportRequest) =>
            request<{ bytes_b64: string; file_name: string }>(
                baseUrl,
                "/api/cli-market/export/json",
                {
                    method: "POST",
                    ...jsonBody(input),
                },
        ...
        cliPublish: (id: string) =>
            request<CliMarketEntry>(
                baseUrl,
                `/api/cli-market/${encodeURIComponent(id)}/publish`,
                {
                    method: "POST",
                    ...jsonBody({}),
                },
        ...
        cliArchive: (id: string) =>
            request<CliMarketEntry>(
                baseUrl,
                `/api/cli-market/${encodeURIComponent(id)}/archive`,
                {
                    method: "POST",
                    ...jsonBody({}),
                },
...
export function getApiBaseUrl(): string {
    ...
    // Browser dev mode: Next.js proxies /api → backend via rewrites.
    return "";
}

/** Create an API client that auto-detects the backend URL. */
