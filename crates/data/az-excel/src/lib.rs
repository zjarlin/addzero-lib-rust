...
//!
//! ```rust,no_run
//! use az_excel::{ExcelWorkbook, ExcelSheet, CellValue, write_xlsx, read_xlsx};
//!
...
//! write_xlsx("/tmp/output.xlsx", &workbook).unwrap();
//!
//! let loaded = read_xlsx("/tmp/output.xlsx").unwrap();
