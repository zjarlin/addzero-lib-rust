...
//! `RealtimeTranscriptionSessionCreateRequestGAAudioInput` DTO.
...
pub struct RealtimeTranscriptionSessionCreateRequestGAAudioInput {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub noise_reduction: Option<RealtimeTranscriptionSessionCreateRequestGAAudioInputNoiseReduction>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
