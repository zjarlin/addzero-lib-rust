...
pub trait OpenAiModelsApi: Send + Sync {
    ...
    async fn list_models(&self) -> Result<OpenAiResponseBody, Self::Error>;
    ...
    async fn delete_model(&self, model: String) -> Result<OpenAiResponseBody, Self::Error>;

    /// Retrieves a model instance, providing basic information about the model such as the owner and permissioning.
    ///
    /// REST: `GET /models/{model}`.
    /// Path constant: [`OpenAiApiPath::MODELS_BY_MODEL`](crate::paths::OpenAiApiPath::MODELS_BY_MODEL).
    async fn retrieve_model(&self, model: String) -> Result<OpenAiResponseBody, Self::Error>;
}
