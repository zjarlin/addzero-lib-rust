...
pub trait OpenAiFilesApi: Send + Sync {
    ...
    /// us](https://help.openai.com/) if you need to increase these storage limits.
    ///
    /// REST: `POST /files`.
    /// Path constant: [`OpenAiApiPath::FILES`](crate::paths::OpenAiApiPath::FILES).
    async fn create_file(&self, body: CreateFileRequest) -> Result<OpenAIFile, Self::Error>;
    ...
    /// Path constant: [`OpenAiApiPath::FILES_BY_FILE_ID`](crate::paths::OpenAiApiPath::FILES_BY_FILE_ID).
    async fn delete_file(&self, file_id: String) -> Result<DeleteFileResponse, Self::Error>;
