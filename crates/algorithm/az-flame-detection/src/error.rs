...
/// 火焰检测 API 统一使用的 Result。
pub type FlameDetectionResult<T> = Result<T, FlameDetectionError>;

/// 火焰检测执行过程中可能出现的错误。
#[derive(Debug, thiserror::Error)]
pub enum FlameDetectionError {
    /// 文件系统操作失败。
