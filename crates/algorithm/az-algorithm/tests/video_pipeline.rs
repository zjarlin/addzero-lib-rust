...
use az_algorithm::components::face_recognition::model::{
...
fn person_fixture_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/tests/fixtures/person_detection/input")
...
fn person_model_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/resources/person_detection/models")
...
fn face_fixture_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/tests/fixtures/face_detection/input")
            .join("face.jpg"),
    )
    .expect("人脸检测测试图片必须存在")
}
...
fn face_model_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/resources/face_detection/models")
...
fn safety_helmet_fixture_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/tests/fixtures/safety_helmet_detection/input")
...
fn safety_helmet_model_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/resources/safety_helmet_detection/models")
...
fn vehicle_fixture_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/tests/fixtures/vehicle_detection/input")
            .join("person_vehicle.jpg"),
    )
    .expect("车辆检测测试图片必须存在")
}
...
fn vehicle_model_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/resources/vehicle_detection/models")
            .join("coco_ssd_mobilenet_v1_10.onnx"),
    )
    .expect("车辆检测模型必须存在")
}
...
fn flame_fixture_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/tests/fixtures/flame_detection/input")
            .join("flame.jpg"),
    )
    .expect("火焰检测测试图片必须存在")
}
...
fn flame_model_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/resources/flame_detection/models")
...
fn face_recognition_model_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/resources/face_recognition/models")
...
fn qr_code_fixture_path() -> PathBuf {
    std::fs::canonicalize(
        workspace_root()
            .join("crates/algorithm/az-algorithm/tests/fixtures/qr_code_recognition/input")
            .join("qr_code.png"),
    )
    .expect("二维码测试图片必须存在")
}
