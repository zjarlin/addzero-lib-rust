...
/// [`WorkerHitVideoAnalysisRun::valid_hit_count_of`](crate::logic_worker_hit_counting::model::WorkerHitVideoAnalysisRun::valid_hit_count_of)。
///
/// # Errors
/// 视频文件不存在、ffmpeg 不可用、ONNX 推理失败、图片处理失败或输出文件写入失败时返回错误。
///
...
mod tests {
    ...
    use crate::logic_worker_hit_counting::assist::target_response_score_near_contact;
    use crate::logic_worker_hit_counting::model::{
