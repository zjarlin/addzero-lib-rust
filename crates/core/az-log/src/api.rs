...
macro_rules! trace_for {
    ($value:expr, $($arg:tt)+) => {
        ::log::trace!(target: $crate::api::value_logger_target(&$value), $($arg)+)
    };
}
...
macro_rules! debug_for {
    ($value:expr, $($arg:tt)+) => {
        ::log::debug!(target: $crate::api::value_logger_target(&$value), $($arg)+)
    };
}
...
macro_rules! info_for {
    ($value:expr, $($arg:tt)+) => {
        ::log::info!(target: $crate::api::value_logger_target(&$value), $($arg)+)
    };
}
...
macro_rules! warn_for {
    ($value:expr, $($arg:tt)+) => {
        ::log::warn!(target: $crate::api::value_logger_target(&$value), $($arg)+)
    };
}
...
macro_rules! error_for {
    ($value:expr, $($arg:tt)+) => {
        ::log::error!(target: $crate::api::value_logger_target(&$value), $($arg)+)
    };
}
