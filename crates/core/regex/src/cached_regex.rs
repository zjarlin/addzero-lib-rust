...
impl CachedRegex {
    ...
    ///
    /// ```
    /// use az_regex::cached_regex::CachedRegex;
    ///
...
///
/// ```
/// use az_regex::cached_regex::{CachedRegex, named_captures_to_map};
///
/// # fn main() -> Result<(), Box<dyn std::error::Error>> {
...
///
/// ```
/// use az_regex::cached_regex::extract_all;
///
...
///
/// ```
/// use az_regex::cached_regex::is_valid_pattern;
///
